  ...
  <section class="image-gallery">
  	...
  	<!--single item strt-->
  		<div class="col-md-4 position">
  			<img src="images/care info.jpg" alt="Roses" class="gallery-image">
  	...
  	<div class="col-md-4 position">
  			<img src="images/ad.jpg" alt="Roses" class="gallery-image">
  	...
  	<!--single item strt-->
  		<div class="col-md-4 position">
  			<img src="images/rescue1.jpg" alt="Roses" class="gallery-image">
