  ...
  <div class="container">
   <div class="row">
     ...
     <div class="origin-img">
        <img src="images/origin1.jpg" alt="bouquet">
'         </div>
          </div>
    <div class="col-lg-4  col-md-6 position-absolute top-50 start-50">
   <div class="origin-desc  ">
     <span><b>Animal Help</b></span>
     <h1>Our Origin</h1>
     <p>Animal Help is a trendsetting online store, offering our first-rate products and exceptional customer service to shoppers from the comfort of their own homes. We’re a business made up of innovators and forward-thinkers, with the drive and wherewithal to constantly update and improve the online shopping experience.</p>
       ...
       <div class="row">
         <div class="col-lg-6">
          ...
          <div class="policies-image">
            <img src="images/about.jpg" alt="flower shop">
          </div>
